...
const moreSongs = ["On My Mind", ...songs, "Time Alone"];
...
function add(x, y, z) {
  const array = [x, y, z];
  return array.reduce((a, b) => a + b); // you don't have to change this line of code but look up reduce if you're not sure what it does here https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/reduce
}
console.log(add(1, 2, 3)); // 6
const addSpread = (...nums) => {
